...
from _app.core.auth import gerar_hash_senha, verificar_senha
from _app.core.configs import settings
from _app.core.database import get_session
from _app.models.membro_model import MembroModel
from _app.controllers.base_controller import BaseController
...
class MembroController(BaseController):
    ...
    async def post_register(self, dados: dict) -> None:
        nome: str = dados.get('nome')
        funcao: str = dados.get('funcao')
        ...
        # Instanciar o objeto
        membro = MembroModel(nome=nome, funcao=funcao, imagem=novo_nome, email=email, senha=hash_senha)
